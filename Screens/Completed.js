...
export default function Completed({ navigation }) {
        ...
        <TouchableOpacity style={styles.TO} onPress={() => {
            ...
            <View style={styles.renderFlex}>
                ...
                <View style={styles.renderFlex1}>
                    {/* <TouchableOpacity onPress={() => { complete(item) }}>
    ...
    return (
        <View style={styles.Container}>
            ...
            />
            {/* <Button title= "show complete data" onPress={()=>{console.log("This is completeData",CompleteData)}}></Button> */}
